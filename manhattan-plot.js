...
function createInstance(options) {
    ...
    function outdent(stringsOrOptions) {
        ...
        if (isTemplateStringsArray(stringsOrOptions)) {
            ...
            return createInstance(extend$3(extend$3({}, options), stringsOrOptions || {}));
        }
    }
    var fullOutdent = extend$3(outdent, {
        string: function (str) {
...
function invokePartial(partial, context, options) {
  ...
  if (options.fn && options.fn !== noop$2) {
    (function () {
...
function parseCss$1(value) {
  ...
  return m.isIdentity ? identity$1 : decompose$1(m.a, m.b, m.c, m.d, m.e, m.f);
}
...
function parseSvg$1(value) {
  ...
  if (!(value = svgNode$1.transform.baseVal.consolidate())) return identity$1;
  value = value.matrix;
...
function onFunction$1(id, name, listener) {
  var on0, on1, sit = start$1(name) ? init$2 : set$2;
  return function() {
...
class ManhattanPlot extends Stanza {
  ...
  draw(stanza, params) {
    ...
    const canvasDiv = select$1(chartElement)
      .append("div")
    ...
    const svg = select$1(chartElement)
      .append("svg")
      .attr("width", width)
    ...
    const tooltip = select$1(chartElement)
      .append("div")
      .attr("class", "tooltip");
    ...
    // slider
    const ctrlSvg = select$1(controlElement)
      .append("svg")
    ...
    // button
    const ctrlBtn = select$1(controlElement)
      .append("div")
      .attr("id", "ctrl_button");
    ctrlBtn
      .append("span")
